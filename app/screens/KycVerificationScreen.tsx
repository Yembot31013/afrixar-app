...
interface KycVerificationScreenProps extends AppStackScreenProps<"KycVerification"> {}

export const KycVerificationScreen: FC<KycVerificationScreenProps> =
        ...
        <ScrollView contentContainerStyle={themed($content)} showsVerticalScrollIndicator={false}>
          <View style={themed($hero)}>
            <View style={themed($iconCircle)}>
              <Ionicons name="shield-checkmark" size={34} color={colors.palette.success500} />
            </View>
            ...
            <Text text="KYC status: Approved" preset="subheading" />
          </View>

          <View style={themed($group)}>
            <DetailRow label="Legal name" value="A***a W******u" />
            <DetailRow label="DOB" value="** / ** / 19**" />
            <DetailRow label="Selfie match" value="Passed · 97% confidence" />
            <DetailRow label="Verified on" value="07 May 2026 · 10:41" />
          </View>
        </ScrollView>
      </SafeAreaView>
    )
