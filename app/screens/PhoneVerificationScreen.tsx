...
interface PhoneVerificationScreenProps extends AppStackScreenProps<"PhoneVerification"> {}

export const PhoneVerificationScreen: FC<PhoneVerificationScreenProps> =
        ...
        <ScrollView contentContainerStyle={themed($content)} showsVerticalScrollIndicator={false}>
          <View style={themed($hero)}>
            <View style={themed($iconCircle)}>
              <Ionicons name="call-outline" size={34} color={colors.palette.success500} />
            </View>
            ...
            <Text text="Phone status: Active" preset="subheading" />
          </View>

          <View style={themed($group)}>
            <DetailRow label="Phone number" value="+254 7** *** 289" />
            <DetailRow label="Verification method" value="SMS OTP + backup call" />
            <DetailRow label="2FA" value="Enabled" />
            <DetailRow label="Last confirmed" value="07 May 2026 · 09:55" />
          </View>
        </ScrollView>
      </SafeAreaView>
    )
